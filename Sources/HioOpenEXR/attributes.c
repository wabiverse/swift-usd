...
#include <OpenEXR/OpenEXRCore/internal_attr.h>

#include <OpenEXR/OpenEXRCore/internal_constants.h>
#include <OpenEXR/OpenEXRCore/internal_structs.h>
...
attr_init (struct _internal_exr_context* ctxt, exr_attribute_t* nattr)
{
    ...
    {
        case EXR_ATTR_BOX2I: {
            exr_attr_box2i_t nilVar = {0};
            *(nattr->box2i)      = nilVar;
            break;
        }
        case EXR_ATTR_BOX2F: {
            exr_attr_box2f_t nilVar = {0};
            *(nattr->box2f)      = nilVar;
            break;
        }
        case EXR_ATTR_CHLIST: {
            exr_attr_chlist_t nilVar = {0};
            *(nattr->chlist)      = nilVar;
            break;
        }
        case EXR_ATTR_CHROMATICITIES: {
            exr_attr_chromaticities_t nilVar = {0};
            *(nattr->chromaticities)      = nilVar;
            break;
        }
        ...
        case EXR_ATTR_FLOAT_VECTOR: {
            exr_attr_float_vector_t nilVar = {0};
            *(nattr->floatvector)       = nilVar;
            break;
        }
        case EXR_ATTR_INT: nattr->i = 0; break;
        case EXR_ATTR_KEYCODE: {
            exr_attr_keycode_t nilVar = {0};
            *(nattr->keycode)      = nilVar;
            break;
        }
        case EXR_ATTR_M33F: {
            exr_attr_m33f_t nilVar = {0};
            *(nattr->m33f)      = nilVar;
            break;
        }
        case EXR_ATTR_M33D: {
            exr_attr_m33d_t nilVar = {0};
            *(nattr->m33d)      = nilVar;
            break;
        }
        case EXR_ATTR_M44F: {
            exr_attr_m44f_t nilVar = {0};
            *(nattr->m44f)      = nilVar;
            break;
        }
        case EXR_ATTR_M44D: {
        ...
        case EXR_ATTR_PREVIEW: {
            exr_attr_preview_t nilVar = {0};
            *(nattr->preview)      = nilVar;
            break;
        }
        case EXR_ATTR_RATIONAL: {
            exr_attr_rational_t nilVar = {0};
            *(nattr->rational)      = nilVar;
            break;
        }
        case EXR_ATTR_STRING: {
            exr_attr_string_t nilVar = {0};
            *(nattr->string)      = nilVar;
            break;
        }
        case EXR_ATTR_STRING_VECTOR: {
            exr_attr_string_vector_t nilVar = {0};
            *(nattr->stringvector)       = nilVar;
            break;
        }
        case EXR_ATTR_TILEDESC: {
            exr_attr_tiledesc_t nilVar = {0};
            *(nattr->tiledesc)      = nilVar;
            break;
        }
        case EXR_ATTR_TIMECODE: {
            exr_attr_timecode_t nilVar = {0};
            *(nattr->timecode)      = nilVar;
            break;
        }
        case EXR_ATTR_V2I: {
            exr_attr_v2i_t nilVar = {0};
            *(nattr->v2i)      = nilVar;
            break;
        }
        case EXR_ATTR_V2F: {
            exr_attr_v2f_t nilVar = {0};
            *(nattr->v2f)      = nilVar;
            break;
        }
        case EXR_ATTR_V2D: {
            exr_attr_v2d_t nilVar = {0};
            *(nattr->v2d)      = nilVar;
            break;
        }
        case EXR_ATTR_V3I: {
            exr_attr_v3i_t nilVar = {0};
            *(nattr->v3i)      = nilVar;
            break;
        }
        case EXR_ATTR_V3F: {
            exr_attr_v3f_t nilVar = {0};
            *(nattr->v3f)      = nilVar;
            break;
        }
        case EXR_ATTR_V3D: {
            exr_attr_v3d_t nilVar = {0};
            *(nattr->v3d)      = nilVar;
            break;
        }
        case EXR_ATTR_OPAQUE: {
            exr_attr_opaquedata_t nilVar = {0};
            *(nattr->opaque)          = nilVar;
            break;
        }
